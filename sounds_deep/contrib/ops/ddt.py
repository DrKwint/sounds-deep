...
class TransductiveBoxInference(snt.AbstractModule):
    """
    Calculates the probability mass which falls into an axis aligned hyperbox

    Assists in predicting the class label of a sample drawn from a factored Gaussian
