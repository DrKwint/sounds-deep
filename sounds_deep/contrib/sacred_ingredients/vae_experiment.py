...
from define_vae_ingredient import define_vae_ingredient, define_model, write_verbose_ops
from train_ingredient import train_ingredient, run_training

ex = sacred.Experiment(
    'vae_experiment', ingredients=[load_data_ingredient, define_vae_ingredient, train_ingredient])
