...
from define_gmm_vae_ingredient import define_gmm_vae_ingredient, define_model, write_verbose_ops
from train_ingredient import train_ingredient, run_training

ex = sacred.Experiment(
    'gmm_vae_experiment', ingredients=[load_data_ingredient, define_gmm_vae_ingredient, train_ingredient])
